...
async function staffFlow(browser) {
  ...
  await page.click('#historyButton'); await page.waitForSelector('[data-restore-id]'); await page.click('[data-restore-id]');
